...
```{r otm1-bayesian-replication-analysis, cache = TRUE, dependson = "otm1-bayesian-replication-design-matrix"}
# No effect model
...
```{r otm1-bayesian-replication-analysis-samples, cache = TRUE, dependson = "otm1-bayesian-replication-analysis"}
# Fixed effect model
