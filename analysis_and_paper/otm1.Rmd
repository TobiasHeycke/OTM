...
dev_table <- data.frame(
  ...
  `Reader Impact` = c(
    ...
    "As we have found our results to be consistent across languages, countries, and locations within the USA, we believe this deviation to be consequential for our conclusions.",
    ""
  ),
  check.names = FALSE,
