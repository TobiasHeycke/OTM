...
To give a vivid impression of the experimental procedure, an exemplary video recording is available at https://osf.io/hmcfg/.
...
otm_descriptives <- bind_rows(
  ...
  full_join(
    bind_rows(
      ...
      mutate(
        Location = if_else(Duration == "20", "Florida, Williams", "Hong Kong, Illinois, Yale") |>
