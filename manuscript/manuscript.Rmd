...
One way to investigate this question is to compare direct and indirect measures of evaluation.
Direct measures (e.g., Likert scales) assumedly elicit relatively more explicit, conscious, effortful, and controllable evaluations (hereafter explicit evaluations).
Indirect measures [e.g., the Implicit Association Test [IAT], @greenwald_measuring_1998], assumedly elicit relatively more implicit, unconscious, effortless, and uncontrollable evaluations (hereafter implicit evaluations).
...
**Materials**: All study materials are publicly available (https://osf.io/8m3xb/). We share blurred versions of the photographs used in the learning phase and for the IAT, because we do not have permission from the depicted individuals to publicly share their photographs.
...
**Preregistration**: The hypotheses, methods, and analysis plans were preregistered as a Stage-1 registered report (https://doi.org/10.17605/OSF.IO/R3KJH) on November 9th, 2020, prior to data collection, which began on September 23rd, 2021. We describe deviations in Table\ \@ref(tab:otm-preregistration-deviation-table).
**Materials**: All study materials are publicly available (https://osf.io/8m3xb/). We share blurred versions of the photographs used in the learning phase and for the IAT, because we do not have permission from the depicted individuals to publicly share their photographs.
**Data**: All primary data are publicly available (https://osf.io/8m3xb/). 
**Analysis scripts**: All analysis scripts are publicly available (https://osf.io/8m3xb/).
